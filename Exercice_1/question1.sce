...
disp('Nous remarquons que les densités des deux populations varient presque de la même manière ! Cependant la variation de la densité des Lynx est légèrement plus grande (c''est à dire plus faible à la fin) ! Aucun des deux espèces ne gagnent sur cette compétition !')
